...
<div class="form">
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'phone',array('size'=>20,'maxlength'=>20,'class'=>'width200')); ?>
	...
	<div class="row submit">
		<?php echo CHtml::submitButton(Yii::t('common', 'Registration'), array('class' => 'submit-button')); ?>
	</div>
