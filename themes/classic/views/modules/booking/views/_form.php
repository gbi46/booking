...
<div class="row">
	...
	<div class="full-multicolumn-second">
		...
		<?php echo $form->dropDownList($model,'time_in', HBooking::getTimesIn(), array('class' => 'width150')); ?>
...
<div class="row">
	...
	<div class="full-multicolumn-second">
		...
		<?php echo $form->dropDownList($model,'time_out', HBooking::getTimesOut(), array('class' => 'width150')); ?>
