<?php
	...
	Yii::app()->clientScript->registerScript('generate-phone-apartment-'.$data->id, '
		function generatePhone(){
			$.get(\''.Yii::app()->controller->createUrl('/apartments/main/generatephone', array('id' => $data->id)).'\', function(data) {
