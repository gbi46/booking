...
<div class="" id="metro-block"
    ...
    <?php
    echo Chosen::multiSelect('Apartment[metroSrc][]', $model->metroSrc, $metros, array('id' => 'metro', 'class' => ' searchField form-control', 'data-placeholder' => tt('Select metro stations', 'metroStations'))
    );
