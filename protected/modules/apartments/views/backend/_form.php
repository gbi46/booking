    ...
    <div class="tabbable">
        <ul class="nav nav-tabs" id="myTabs">
            ...
            <?php if ($model->objType->with_obj) : ?>
                <li><a href="#tab-childs" data-toggle="tab"><?php echo tc('child_section_' . $model->objType->id); ?></a></li>
            <?php endif; ?>
            ...
            <?php
            if (!$model->isNewRecord && (param('useGoogleMap', 1) || param('useYandexMap', 1) || param('useOSMMap', 1)) && $model->type != Apartment::TYPE_BUY && $model->type != Apartment::TYPE_RENTING
            ) {
                    ...
                    if ($video->isFile()) {
                        if ($video->isFileExists()) {
                            ...
                            <div class="video-file-block">
                                <video id="realty-video-<?php echo $video->id; ?>" class="video-js vjs-default-skin" controls preload="auto" width="615" height="254">
