...
<?php if (issetModule('location')): ?>
    ...
    <div class="form-group">
        ...
        <?php
        echo Select2::activeDropDownList($model, 'loc_region', $regions, array('id' => 'ap_region',
            'ajax' => array(
                'type' => 'GET', //request type
    ...
    <?php if (issetModule('metroStations')): ?>
        ...
        <div class="form-group" id="locationCity"<?php
        if (param('allowCustomCities') && $model->customCity) {
        ...
        <?php if (param('allowCustomCities')): ?>
            <div class="form-group" id="customCity"<?php
            if (!$model->customCity) {
                echo ' style="display: none;"';
            }
        ...
        <?php endif; ?>
        <div class="form-group" id="metro-block-apartment" style="display: <?php echo ($metros && count($metros) > 1) ? 'block;' : 'none;'; ?>">
